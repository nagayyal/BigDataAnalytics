...
print "2) Flights which are not cancelled per month"
 
 
cancelFlightsBadWeather = df_air_time.filter( (df_air_time.CANCELLATION_CODE == 'A'))
 
print "Flights which are not cancelled per month"
