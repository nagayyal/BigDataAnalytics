...
print "3) Top 5 cancellation flights per year due to bad weather"
mostcancelFlightsBadWeatherYear = cancelFlightsBadWeather.groupby('YEAR', 'FL_NUM').count().orderBy('count', ascending=False).limit(5)
print mostcancelFlightsBadWeatherYear.collect()
