...
print "13) Number of flights with arrDelay<15 and depDelay<15"
totalflightswith15delay = df_air_time.filter( (df_air_time.ARR_DELAY < 15) & (df_air_time.DEP_DELAY < 15))
print totalflightswith15delay.count()
