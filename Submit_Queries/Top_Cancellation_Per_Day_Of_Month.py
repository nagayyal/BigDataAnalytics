...
print "4) Top cancellation flight per DayofMonth due to bad weather"
mostcancelFlightsBadWeatherDay = cancelFlightsBadWeather.groupby('DAY_OF_MONTH', 'FL_NUM').count().orderBy('count', ascending=False).limit(5)
print mostcancelFlightsBadWeatherDay.collect()
